  ...
  return (
    <div className="festival-menu-decoration" aria-hidden="true">
      ...
      <div className="festival-menu-decoration-rail festival-menu-decoration-rail--right">
        <WheatCluster className="festival-menu-decoration-cluster festival-menu-decoration-cluster--d" flip />
        ...
        return (
          <g key={i}>
            ...
            <line
              ...
              opacity="0.72"
            />
            <circle cx={24 - len} cy={y - 3.5} r="1.35" fill="none" stroke="currentColor" strokeWidth="1" />
            <circle cx={24 + len} cy={y - 3.5} r="1.35" fill="none" stroke="currentColor" strokeWidth="1" />
          </g>
        );
      })}
  ...
  return (
    ...
    >
      <g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M28 70 l-7 -5 M28 82 l-7 -5 M28 94 l-6 -4" strokeWidth="1" opacity="0.7" />
        <path d="M56 74 l7 -5 M56 86 l7 -5 M56 98 l6 -4" strokeWidth="1" opacity="0.7" />
      </g>
    </svg>
  );
}
...
function PartialWindmill({ className = "" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 90 120" width="90" height="120" focusable="false">
      <g fill="none" stroke="currentColor" strokeWidth="1.15" strokeLinecap="round">
        <path d="M44 118 V58" />
        <path d="M36 118 h16" />
        <circle cx="44" cy="52" r="3.5" />
        <path d="M44 52 L18 28 M44 52 L70 28 M44 52 L20 78 M44 52 L68 76" opacity="0.85" />
        <path d="M44 52 L30 18 M44 52 L58 18 M44 52 L26 70 M44 52 L62 70" opacity="0.55" />
      </g>
    </svg>
  );
}
...
function GrassTuft({ className = "" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 60 90" width="60" height="90" focusable="false">
...
function FenceFragment({ className = "" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 100 70" width="100" height="70" focusable="false">
      <g fill="none" stroke="currentColor" strokeWidth="1.15" strokeLinecap="round">
...
function RoofPeak({ className = "" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 90 70" width="90" height="70" focusable="false">
...
export function FestivalVillageHorizon({ className = "" }: { className?: string }) {
  return (
    <svg
    ...
    >
      <g fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {/* Left plants */}
        <path d="M36 72 V48 M30 52 l-6 -10 M36 50 l0 -14 M42 52 l6 -10" opacity="0.85" />
        <circle cx="24" cy="40" r="2.2" />
        <circle cx="36" cy="34" r="2.2" />
        <circle cx="48" cy="40" r="2.2" />
        <path d="M68 72 V50 M62 54 l-5 -9 M68 52 l0 -12 M74 54 l5 -9" opacity="0.8" />
        ...
        <path d="M130 38 L112 22 M130 38 L148 22 M130 38 L114 56 M130 38 L146 54" opacity="0.9" />
        {/* House */}
        ...
        {/* Right plants */}
        <path d="M620 72 V50 M614 54 l-5 -9 M620 52 l0 -12 M626 54 l5 -9" opacity="0.8" />
        <circle cx="609" cy="43" r="2" />
        <circle cx="620" cy="38" r="2" />
        <circle cx="631" cy="43" r="2" />
        <path d="M660 72 V48 M654 52 l-6 -10 M660 50 l0 -14 M666 52 l6 -10" opacity="0.85" />
